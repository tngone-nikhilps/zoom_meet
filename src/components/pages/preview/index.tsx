...
const PreviewContainer = () => {
  ...
  return (
    <div className="js-preview-view">
      <div id="js-preview-view" className="w-full preview__root">
        <div className="container video-app">
          ...
          <div className="mt-[2.3rem]  video-operations video-operations-preview">
            <div className="flex gap-[1.2rem]">
              ...
              <CameraButton
                ...
                isPreview={true}
              />
              <button className="bg-[#1A71FF] text-[#FFFF]  text-[1.12rem] rounded-[4rem] w-[9rem] h-[3.75rem] font-[600]">
                Join
              </button>
            </div>
          </div>
