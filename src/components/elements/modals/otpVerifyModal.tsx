...
function OtpVerifyModal({ userEmail, openModal, setOpenModal }: Props) {
    ...
    return (
        <div className="fixed  inset-0 z-30 bg-black bg-opacity-50 flex justify-center items-center">
            <div className="relative  dark:bg-[#313131] mobile:px-1 bg-white dark:text-white text-black border border-black  rounded-[38px]  w-[35.91304rem] mobile:w-[20rem] h-[24.56522rem] flex  items-center flex-col">
                <div
                ...
                >
                    {[...Array(length)].map((_, index) => (
                        <input
                            ...
                            className={`w-[3.78409rem] h-[3.78409rem] mobile:w-[2.3rem] mobile:h-[3rem] mb-4 rounded-[15px] mobile:rounded-[10px] dark:bg-[#313131] border-[2px] border-[#D9D9D9] p-3 mobile:p-1 text-center appearance-none text-[1.17439rem] font-medium focus:border-[#00B152] focus:outline-none focus:ring-0 ${validateOtp !== "" && "border-red-500"
                                }`}
                            type="text"
                            maxLength={1}
                            onPaste={(e) =>
